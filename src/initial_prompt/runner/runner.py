...
PROMPT = open("src/initial_prompt/runner/runner.jinja2", "r", encoding="utf-8").read().strip()
RERUNNER_PROMPT = open("src/initial_prompt/runner/rerunner.jinja2", "r", encoding="utf-8").read().strip()
        ...
        for command in commands:
            ...
            while command_failed and retries < 2:
                ...
                if action == "command":
                    ...
                    ProjectManager().add_message_from_angelic(project_name, response)
